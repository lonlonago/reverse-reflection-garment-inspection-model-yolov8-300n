# Reverse-reflection garment inspection model YOLOv8-300n

# Body

Reflexive clothing detection model YOLOv8-300n
Provide the trained model file (pt format), process file and validation images, with the corresponding training dataset of 8800 pieces, training times of 300, suitable for learning research.
